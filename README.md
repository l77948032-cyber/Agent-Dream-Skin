...
打开 [http://127.0.0.1:5173/](http://127.0.0.1:5173/)，即可进入主题中心。
...
欢迎提交主题灵感、目标应用建议、兼容性反馈与 Pull Request。提交问题时，建议附上目标
应用版本、系统版本、复现步骤和截图，方便快速定位。

- [提交 Issue](https://github.com/l77948032-cyber/Agent-Dream-Skin/issues)
- [查看发布验收说明](./docs/release-checklist.md)
- [素材与来源说明](./NOTICE.md)
