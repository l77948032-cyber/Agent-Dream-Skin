...
| WorkBuddy Plugin | `plugins/workbuddy/` | 三套 WorkBuddy 模板、schema、32 个语义组件、8 个场景、runtime mapping 和 runtime adapter |
...
- WorkBuddy `5.2.6` 基线上的 macOS CDP runtime、三套模板、32 个组件和 8 个 Studio 场景；
